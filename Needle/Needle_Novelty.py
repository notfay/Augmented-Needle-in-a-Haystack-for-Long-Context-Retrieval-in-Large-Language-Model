...
if __name__ == "__main__":
    ...
    # Test needles
    test_needles = [
     "The data was collected over a long period of time to ensure accuracy. The analysis revealed a significant change in the rate of the process. This finding is consistent with previous tests in the field.",
     "The researchers analyzed the content of the documents. The frequency of certain words was calculated. The results showed a clear difference in the language used.",
     "The experiment tested the limit of the material. The stress was increased until the sample failed. The data provided information on the strength of the material.", 
    "The study compares the two different approaches to the problem. The results show that the first approach is more effective. The second approach was found to be too costly.",
    ]
